...
const item = (closed: boolean): SquareOpinionItem => ({type: 1, sourceID: '1', actorIdentifier: 'alice', actor: {identifier: 'alice', nickname: 'Alice'}, sortTime: {seconds: 100, nanos: 0}, content: {

...
const row = {rank: 1, identity: {type: 'external_user', id: 'subject:1'}, profile: {display_name: 'Alice', username: 'alice', avatar_url: '', x_handle: 'alice_x'}, platforms: ['FOMO'], dimension: 'Global', pnl_basis: 'window_realized_plus_current_unrealized', total_profit_usd: '9007199254740993.12', snapshot_at: 1789536543, chains: ['sol', 'base'], identity_revision: 'v1'};
